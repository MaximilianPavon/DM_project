...
\usepackage[latin1,applemac]{inputenc}	%% deutsche Umlaute wie normale
 								...
 								%% (ansonsten muesste ï¿½ durch a getippt werden)
\usepackage{a4wide} 				%% kleinere Seitenrï¿½nder
...
\begin{figure}[h!]
\includegraphics[width=0.9\linewidth]{figures/2_2_soc-Epinions1_lscc.png}
\caption{First approximation of the network statistics by \textbf{sampling random pairs of vertices} to approximate network statistics as a function of the accuracy parameter for the \textbf{LSCC} for the network \textit{soc-Epinions1}. The dashed line corresponds to the exact value of the network statistics in the same color.}
\label{pic:2_2_soc-Epinions1_lscc}
\end{figure}

\begin{figure}[h!]
\includegraphics[width=0.9\linewidth]{figures/2_2_soc-Epinions1_lwcc.png}
\caption{First approximation of the network statistics by \textbf{sampling random pairs of vertices} to approximate network statistics as a function of the accuracy parameter for the \textbf{LWCC} for the network \textit{soc-Epinions1}.The dashed line corresponds to the exact value of the network statistics in the same color.}
