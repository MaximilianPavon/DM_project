...
\textbf{running time nX} 	&		4min		&		N/A			&N/A				&N/A	\\
...
They are all surprisingly good. noice

\item Which of the three approximation methods is better and why?

The second method looks superior. It takes less accuracy to get to closer values of ground true than the first approximation method.

\item What is the recommended value of the accuracy parameter, according to your experiments?

Regarding the plots, between $0.1$ and $0.2$.
